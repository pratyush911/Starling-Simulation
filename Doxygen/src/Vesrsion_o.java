...
public class Boid2D {
  ...
  ///Apply Force on birds (Change velocity)
...
public PVector avoidObstacles() {
  ...
  ///Align bird by seeing velocity of neighbouring birds
  ...
  ///Find nearest neighbours from all the Boids
  ...
  ///Update function run every cycle
  public void update() {
...
public class Boid {
  ...
  ///This gives birds roost to stay atop
  ...
  ///Avoidance and prevention from collissions with each other
...
///Draw function for 2D rendering
public void draw2D() {
  ///Background
...
///Threads for 2D rendering
public class MyThread2D implements Runnable { 
  ///No.of threads
  int thread_num;
  ///Constructor
